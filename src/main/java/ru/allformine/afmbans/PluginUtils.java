...
public class PluginUtils {
    public static void broadcastPunishMessage(CommandSource src, String target, PunishType type) {
        ...
        Text text = Text.builder()
                ...
                .append(Text.of(" игрока")).color(TextColors.RESET)
                .append(Text.of(target)).color(PluginStatics.BROADCAST_COLOR)
                .append(Text.of("навсегда.")).color(TextColors.RESET)
                .build();
    ...
    public static Text getBanMessageForPlayer(String source, String reason) {
        Text message = Text.builder()
                ...
                .append(Text.of("\n\n"))
                .append(Text.of("От: ")).color(TextColors.RESET)
                .append(Text.of(source)).color(PluginStatics.BAN_MESSAGE_COLOR)
                .append(Text.of("\n\n"))
                .append(Text.of("По причине: ")).color(TextColors.RESET)
